...
// node_modules/custom-cursor-react/dist/index.modern.js
...
// node_modules/custom-cursor-react/dist/index.modern.js
var addHoverEvent = function addHoverEvent2(cursor, targets) {
  if (!targets) return;
...
var removeHoverEvent = function removeHoverEvent2(cursor, targets) {
  if (!targets) return;
  if (Array.isArray(targets)) {
    targets.forEach(function(target) {
      [].forEach.call(document.querySelectorAll(target), function(el) {
...
var Cursor = function() {
  function Cursor2(el, smoothness, opacity, targetOpacity, targetScale) {
    var _this = this;
    this.bindAll();
    this.DOM = {
      el
...
var CustomCursor = function CustomCursor2(_ref) {
  var targets = _ref.targets, customClass = _ref.customClass, fill = _ref.fill, smoothness = _ref.smoothness, strokeColor = _ref.strokeColor, strokeWidth = _ref.strokeWidth, dimensions = _ref.dimensions, opacity = _ref.opacity, targetOpacity = _ref.targetOpacity, targetScale = _ref.targetScale;
...
CustomCursor.propTypes = {
  targets: import_prop_types.default.oneOfType([import_prop_types.default.array, import_prop_types.default.string]),
  customClass: import_prop_types.default.oneOfType([import_prop_types.default.array, import_prop_types.default.string]),
  smoothness: import_prop_types.default.oneOfType([import_prop_types.default.number, import_prop_types.default.shape({
    movement: import_prop_types.default.number.isRequired,
    opacity: import_prop_types.default.number.isRequired,
    scale: import_prop_types.default.number.isRequired
  })]),
  ...
  dimensions: import_prop_types.default.number,
  opacity: import_prop_types.default.number,
  targetOpacity: import_prop_types.default.number,
  targetScale: import_prop_types.default.number
};
...
var index_modern_default = CustomCursor;
export {
...
gsap/CSSPlugin.js:
  ...
  *)
*/
//# sourceMappingURL=custom-cursor-react.js.map
